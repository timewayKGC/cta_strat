...
import json
import os
from OpenRangeStrat import OpenRange
...
if __name__ == '__main__':
    ...
    # Bar回测
    engine.initStrategy(OpenRange, setting)
    ...
    mp.addLine(line=chartLog[[ 'upper', 'lower']].reset_index(), colors={"upper": "red",'lower':'blue'}, pos=0)
    mp.resample()
    mp.show()